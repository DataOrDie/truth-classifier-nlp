...
Looking at your results, the clearest signal is class 0 (true statements) is 
  ...
  2. Threshold tuning — scans [0.20 … 0.75] in steps of 0.02, evaluates THRESHOLD_METRIC on OOF predictions (no holdout leakage), prints the full grid table with the winner marked ←
